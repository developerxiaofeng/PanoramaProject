...
public class UploadUtils {
    ...
    private String validateFields(HttpServletRequest request) {
        ...
        // 文件保存目录路径 request.getSession().getServletContext().getRealPath("/")
        savePath = "E:/demo/" + basePath + "/";
        // 文件保存目录URL  request.getContextPath()
        System.out.println("=========>");
        ...
        if (contentType == null || !contentType.startsWith("multipart")) {
            ...
            // 获取上传临时路径  request.getSession().getServletContext().getRealPath("/")
            tempPath = "E:/demo/"  + tempPath + "/";
